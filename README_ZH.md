[English](https://github.com/seriaati) | 中文

# 支持我
☕ 如果我的開源項目對你有所幫助，能收到你的捐贈將讓我非常高興。你的支持不僅激勵了我對程式設計的熱情，還幫助我繼續作為一名學生和開發者的旅程。  
你可以通過以下服務進行捐贈：
...
## Discord 機器人
我製作的 Discord 機器人大多包含圖片生成功能，這意味著我擁有相當的 [Pillow](https://github.com/python-pillow/Pillow) 經驗及 [Figma](https://www.figma.com) 的平面設計經驗。  
...
## 網頁應用（使用[Flet](https://github.com/flet-dev/flet)）
...
## Python API
🎁 [Hoyo Codes](https://github.com/seriaati/hoyo-codes)：用於獲取米哈游遊戲禮品碼的 API。  
...
## LINE 機器人
所有 LINE 機器人皆透過 [line.py](https://github.com/seriaati/line.py) 開發。  
